	...
	<div class="flex h-full flex-col">
		...
		>
			...
			<button
				...
				class="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-text-secondary hover:bg-bg-secondary hover:text-text-primary focus-visible:outline-blue-500"
			>
		...
		<div class="flex-1 overflow-y-auto p-6 space-y-6">
			...
			<!-- Data Management -->
			<div>
				<div class="text-base font-bold text-text-primary mb-4">
