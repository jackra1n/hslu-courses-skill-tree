...
<Sidebar {isOpen} {onClose} label={messages.settings_title()}>
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-6">
        <div class="space-y-2">
          ...
          >
            ...
            <span>{messages.settings_view_github()}</span>
          ...
          >
            ...
            <span>{messages.settings_start_tutorial()}</span>
          </button>
          <div class="flex w-full items-center justify-between gap-3 px-1 py-2 text-base text-text-primary">
            <span>{messages.settings_theme()}</span>
            <ThemeSwitcher />
          </div>
          <div class="flex w-full items-center justify-between gap-3 px-1 py-2 text-base text-text-primary">
            <span>{messages.settings_language()}</span>
            <LanguageSwitcher />
          </div>
        </div>
        ...
        <!-- Data Management -->
        <div>
          <div class="text-base font-bold text-text-primary mb-4">{messages.settings_data_management()}</div>
          <div class="space-y-2">
            <button
            ...
            >
              ...
              <span>{messages.settings_export_data()}</span>
            </button>
            <button
            ...
            >
              ...
              <span>{messages.settings_import_data()}</span>
            </button>
            {#if importError}
            ...
            >
              ...
              <span>{messages.settings_reset_progress()}</span>
            </button>
            <button
            ...
            >
              ...
              <span>{messages.settings_reset_all_data()}</span>
            </button>
          </div>
        </div>
        ...
        <!-- Resources -->
        <div>
          <div class="text-base font-bold text-text-primary mb-4">{messages.settings_resources()}</div>
          <div class="space-y-2">
            <button
            ...
            <span>{messages.settings_assessment_info()}</span>
          </button>
          </div>
        </div>
...
{#if showResetProgressDialog}
  <ConfirmationDialog
    title={messages.settings_reset_progress()}
    message={messages.settings_reset_progress_message()}
    confirmText={messages.settings_reset_progress()}
...
{#if showResetAllDataDialog}
  <ConfirmationDialog
    title={messages.settings_reset_all_data()}
    message={messages.settings_reset_all_data_message()}
    confirmText={messages.settings_reset_all_data()}
    cancelText={messages.common_cancel()}
