					...
					<div class="space-y-6 text-sm text-text-secondary">
						<div>
							<h3 class="font-semibold text-text-primary mb-3">
								{m.assessment_passing()}
							</h3>
							<ul class="space-y-2 ml-4">
								<li>
									<strong>Definitiv bestanden:</strong>
									{m.assessment_definitiv()}
								</li>
								<li>
									<strong>Bedingt bestanden:</strong> {m.assessment_bedingt()}
								</li>
								<li>
									<strong>Nicht bestanden:</strong> {m.assessment_nicht()}
								</li>
							</ul>
						</div>
						<div>
							<h3 class="font-semibold text-text-primary mb-3">
								{m.assessment_consequences()}
							</h3>
							<ul class="space-y-2 ml-4">
								<li>
									<strong>Bedingt bestanden:</strong>
									{m.assessment_consequences_bedingt()}
								</li>
								<li>
									<strong>Nicht bestanden:</strong>
									{m.assessment_consequences_nicht()}
								</li>
